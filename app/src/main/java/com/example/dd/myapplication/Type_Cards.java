...
import static com.example.dd.myapplication.R.array.arrayDates;
import static com.example.dd.myapplication.R.array.arrayName;
import static com.example.dd.myapplication.R.array.arrayNumbers;
import static com.example.dd.myapplication.R.array.arrayPlace;

/**
 * Created by dd on 16.06.2017.
 */

public class Type_Cards extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String[] tempType = getResources().getStringArray(R.array.eventTypes);
    ...
    private void setInitialData1(String eventType) {
        //Очищаем список
        productList.clear();
        ...
        for (int i = 0; i < arrayNumbers.size(); i++) {
            //фильтруем данные
            if (arrayEvents.get(i).equals(eventType)) {
                //добавляем в список productList новый объект Product с параметрами
                productList.add(new Product(arrayName.get(i), arrayDates.get(i), arrayPlace.get(i), imagesArray.get(i)));
            }
        }
